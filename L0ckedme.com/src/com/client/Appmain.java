...
public class Appmain {
	...
	public static void welcomeScreen() {
		...
		System.out.println("BY Kagiso Molefe \n");
	}
	...
	public static void menuDriven() throws FileNotFoundException {
		...
		do {
			...
			System.out.println("\t2. Business Operation menu \n");
			...
			case 2:
				int ch;
				do {
					System.out.println("Enter your choice for Business Operation");
					...
					case 3:
						...
						break;
					case 4:
						System.out.println("Exited from the Business Operation...");
						System.out.println("---------------------------------\n");
						break;
					default:
